...
plt.figure(1)
# crea el lienzo con dos renglone, una culumna y entra a la primera seccion de esta division. 
plt.subplot(211)
#grafica la variable t1 contra la funcion f(t1)con circulos azules y grafica la variable t2 contra la fucnion f(t2) con una linea negra. 
